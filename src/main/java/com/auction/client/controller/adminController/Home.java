...
/// class Home này dùng để thực hiện các yêu cầu của người dùng khi thao tác trên màn hình ,và xử lý các yêu cầu từ server.
...
public class Home {
    ...
    public void onAuctionSessionClick(javafx.event.ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/auction/client/view/admin/admin_qlphiendaugia.fxml")); //Tải file màn hình
            Parent root = loader.load();
    ...
    public void onHistoryClick(javafx.event.ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/auction/client/view/admin/admin_history.fxml")); //Tải file màn hình
            Parent root = loader.load();
    ...
    public void onUsersManagementClick(javafx.event.ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/auction/client/view/admin/admin_quanlinguoidung.fxml")); //Tải file màn hình
            Parent root = loader.load();
    ...
    public void onProductManagementClick(javafx.event.ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/auction/client/view/admin/admin_quanlisanpham.fxml")); //Tải file màn hình
            Parent root = loader.load();
