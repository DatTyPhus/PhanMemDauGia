...
/// class UsersManagement dùng để thực hiện các yêu cầu của người dùng khi thao tác trên màn hình ,và xử lý các yêu cầu từ server.
...
public class UsersManagement {
    ...
    @FXML private TableColumn<?, ?> createdColumn;
